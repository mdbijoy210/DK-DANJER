...
os.system(f'xdg-open https://github.com/SSC-LOL/DK-DANJER/blob/main/approve.%20txt')
...
prinCP=[]
try:
    prox= requests.get('https://github.com/SSC-LOL/DK-DANJER/blob/main/approve.%20txt').text
...
def meyexudi():
  ...
  id = "-".join(uuid)
  try:
    httpCaht = requests.get('https://github.com/SSC-LOL/DK-DANJER/blob/main/approve.%20txt').text
    if id in httpCaht:
      print(fuckyoursali)
